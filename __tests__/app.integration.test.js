...
import { loadModel, handleFile, classifyImage } from '../public/index';
import fs from 'fs';
...
describe('Image Classifier Integration Tests', () => {
    ...
    test('should classify the uploaded image', async () => {
        const fileInput = screen.getByLabelText('Upload an image for classification');
        const file = new File([fs.readFileSync('/Users/khateebmotala/Documents/GitHub/safeDriveHUD/public/Images/testImage1.png')], 'testImage1.png', { type: 'image/png' });
        userEvent.upload(fileInput, file);
